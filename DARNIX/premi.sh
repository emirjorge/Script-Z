...
data_ip="https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/izin"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/"
...
ins_janda() {
wget https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/backup/tm.sh &&  chmod +x tm.sh && ./tm.sh
}
...
function password_default() {
    ...
    CHATID="1574171185"
    KEY="6449810196:AAHMHhdVjfUrre18pHK2YH4H5rqO0_95TnI"
    TIME="10"
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
wget https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/premi-sh/udp.sh && chmod +x udp.sh && ./udp.sh
wget https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/premi-sh/zi.sh && chmod +x zi.sh && ./zi.sh
wget https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/premi-sh/req.sh && chmod +x req.sh && ./req.sh
...
# Version
ver=$( curl https://raw.githubusercontent.com/emirjorge/Script-Z/master/DARNIX/version.conf )
history -c
echo "$ver" > /home/ver
clear
